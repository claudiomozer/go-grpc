...
var file_blog_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x63, 0x0a, 0x04, 0x42,
	...
	0x22, 0x18, 0x0a, 0x06, 0x42, 0x6c, 0x6f, 0x67, 0x49, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xd3, 0x01, 0x0a, 0x0b, 0x42,
...
var file_blog_proto_goTypes = []interface{}{
	...
	(*BlogId)(nil), // 2: blog.BlogId
}
var file_blog_proto_depIdxs = []int32{
	1, // 0: blog.BlogService.CreateBlog:input_type -> blog.Blog
	2, // 1: blog.BlogService.ReadBlog:input_type -> blog.BlogId
	1, // 2: blog.BlogService.UpdateBlog:input_type -> blog.Blog
	2, // 3: blog.BlogService.DeleteBlog:input_type -> blog.BlogId
	0, // 4: blog.BlogService.ListBlogs:input_type -> blog.Empty
	2, // 5: blog.BlogService.CreateBlog:output_type -> blog.BlogId
	1, // 6: blog.BlogService.ReadBlog:output_type -> blog.Blog
	0, // 7: blog.BlogService.UpdateBlog:output_type -> blog.Empty
	0, // 8: blog.BlogService.DeleteBlog:output_type -> blog.Empty
	1, // 9: blog.BlogService.ListBlogs:output_type -> blog.Blog
